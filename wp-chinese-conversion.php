...
//]]>
	...
	if( !$wpcc_direct_conversion_flag )
		wp_enqueue_script('wpcc-search-js', WPCC_ROOT_URL . 'search-variant.js', array(), '1.0', false);
...
function wpcc_template_redirect() {
	...
	if( $wpcc_noconversion_url == get_option('home') . '/' && $wpcc_options['wpcc_use_permalink'] )
		...
		foreach( (array)$wpcc_options['wpcc_used_langs'] as $value ) {
...
function wpcc_get_noconversion_url() {
	global $wpcc_options;
	$reg = implode('|', (array)$wpcc_options['wpcc_used_langs']);
